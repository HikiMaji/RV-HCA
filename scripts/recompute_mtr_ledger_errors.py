...
class _SummaryAccumulator:
    ...
    def finish(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "error_definition": "3D Euclidean distance between receiver realized_state and selected-score MTR position_xyz",
    ...
    with args.input_ledger.open("r", encoding="utf-8") as source_handle, ledger_path.open(
        ...
        for line in source_handle:
            ...
            if row.get("valid_mask") and _real_mtr(row.get("forecast")) and _real_mtr(row.get("ego_forecast")):
                peer_error = _distance(peer, realized)
                ego_error = _distance(ego, realized)
